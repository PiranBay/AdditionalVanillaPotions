...
public class SplashPotionOfBadOmenRecipeFromAwkward implements IBrewingRecipe {
    @Override
    ...
    public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
        return this.isInput(input) && this.isIngredient(ingredient)
                ? PotionUtils.setPotion(new ItemStack(Items.SPLASH_POTION),PotionofBadOmen.POTION_OF_BAD_OMEN.get())
                : ItemStack.EMPTY;
    }
}
